...
int camSig = 10000 + camDelay; // Duration of camera trigger signal (peak), 0.5 ms

unsigned long timeNow = 0;
unsigned long lastBlink = micros();     // offset added to make sure LED will turn on on first cycle
